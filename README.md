...
If `expectedFiles` is the special string `'ANY_FILES'`, any files may be uploaded and file objects will always be stored in an array.
**Note that the `'ANY_FILES'` option should not be used in a production environment.**
